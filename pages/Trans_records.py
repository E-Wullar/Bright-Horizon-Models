...
@st.cache_data
def load_data():
    transactions_df = pd.read_csv(r'C:\BRIGHT HORIZON\BrightHorizon\data\Featured data\bright_horizons_transaction_recs_enriched.csv')
    customer_df = pd.read_csv(r'C:\BRIGHT HORIZON\BrightHorizon\data\Featured data\bright_horizons_customers_enriched.csv')
